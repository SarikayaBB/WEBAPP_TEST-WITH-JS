...
namespace WebApplication1.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<OrdersWithCompanyName> OrdersWithCompanyNames { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrdersWithCompanyName>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("OrdersWithCompanyName");
